...
public class UpdateQuestionWithChoicesCommandValidator : AbstractValidator<UpdateQuestionWithChoicesCommand>
{
    public UpdateQuestionWithChoicesCommandValidator()
    {
        RuleFor(c => c.Question.Id).NotEmpty();
        ...
        {
            choices.RuleFor(choice => choice.Id).NotEmpty();
